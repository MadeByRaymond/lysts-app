        ...
        //   realm = await Realm.open(config);
          Realm.open(config).progress((d1, d2) => {
            ...
            if (wishlistData.length < 1) { this.setState({
                ...
                loading: false,
                noData: {value:true, message: "This wishlist is no longer active"}}) } 
            else {
                let ownerData = (
                ...
                if (ownerData.length < 1){ this.setState({
                    loading: false,
                    noData: {value:true, message: "This wishlist no longer exists"}}) }
                else {
                    this.setState({
        ...
        ? (
            <View style={styles.noContentWrapper}>
                ...
                <View style={{flexDirection: 'row', justifyContent:'center'}}>
                    <Text style={styles.noContentText}>{this.state.noData.message}</Text> 
                </View>
                </View> 
            </View>
        )
