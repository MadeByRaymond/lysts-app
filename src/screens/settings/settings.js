              ...
              {this.state.reportModal ? this.reportModal() : null}
                ...
                >
                  <View style={styles.settingsWrapper}>
                    ...
                    <TouchableOpacity activeOpacity={0.8} onPress={()=>{this.setState({reportModal: true})}}>
                      <View style={styles.settingRow}>
                        <View style={styles.settingSVGWrapper}>
                    ...
                    <TouchableOpacity activeOpacity={0.8} onPress={()=>{this.goToScreenHandler("com.lysts.screen.supportDonations", "Donations & Support")}}>
                      <View style={styles.settingRow}>
                        <View style={styles.settingSVGWrapper}>
                          <Svg height={35} width={32} viewBox="0 0 364 418" fill="none" >
                            <Path
                              d="M271.334 147.074a22.694 22.694 0 01-4.998-15.382c.76-15.252-9.388-29.22-24.128-33.208a22.694 22.694 0 01-13.084-9.506c-8.35-12.786-24.768-18.122-39.04-12.684a22.672 22.672 0 01-16.172 0c-14.272-5.434-30.69-.1-39.04 12.686a22.688 22.688 0 01-13.084 9.506c-14.74 3.99-24.888 17.956-24.128 33.208a22.684 22.684 0 01-4.998 15.382c-9.582 11.892-9.582 29.156 0 41.048a22.686 22.686 0 014.998 15.38c-.76 15.252 9.388 29.218 24.128 33.208 2.66.72 5.136 1.912 7.332 3.492v94.65a5 5 0 008.14 3.89L182 302.61l44.736 36.132a5.003 5.003 0 005.296.622 5 5 0 002.844-4.512v-94.65a22.699 22.699 0 017.334-3.492c14.74-3.99 24.888-17.956 24.128-33.208a22.68 22.68 0 014.998-15.382c9.58-11.89 9.58-29.154-.002-41.046zm-86.192 145.22a5.002 5.002 0 00-6.284 0l-39.736 32.094V251.4c8.958 8.932 22.642 12.13 34.792 7.504a22.672 22.672 0 0116.172 0 32.323 32.323 0 0011.52 2.114c8.636 0 17.08-3.43 23.27-9.596v72.966l-39.734-32.094zm78.406-110.446a32.676 32.676 0 00-7.198 22.154c.528 10.59-6.518 20.288-16.752 23.058a32.673 32.673 0 00-18.844 13.69c-5.798 8.88-17.2 12.582-27.106 8.808a32.714 32.714 0 00-11.646-2.146c-3.946 0-7.892.716-11.646 2.146-9.908 3.772-21.31.07-27.106-8.806a32.674 32.674 0 00-18.844-13.692c-10.236-2.77-17.282-12.468-16.752-23.058a32.68 32.68 0 00-7.198-22.154c-6.652-8.258-6.652-20.244 0-28.5a32.68 32.68 0 007.198-22.154c-.528-10.59 6.518-20.288 16.752-23.058a32.674 32.674 0 0018.844-13.69c5.796-8.88 17.202-12.582 27.106-8.808a32.688 32.688 0 0023.292 0c9.904-3.774 21.308-.072 27.106 8.806a32.675 32.675 0 0018.844 13.692c10.236 2.77 17.282 12.468 16.752 23.058a32.683 32.683 0 007.198 22.154c6.652 8.256 6.652 20.242 0 28.5z"
                              fill="#A58BC9"
                            />
                            <Path
                              d="M361.092 102.714L184.5.758a5.006 5.006 0 00-5 0L2.908 102.714a5.003 5.003 0 00-2.5 4.33v203.91c0 1.786.954 3.436 2.5 4.33L179.5 417.24a5.002 5.002 0 005 0l176.592-101.956a5.003 5.003 0 002.5-4.33v-203.91a5.003 5.003 0 00-2.5-4.33zM182 407.138l-171.592-99.07V115.704l62.034 35.816a4.998 4.998 0 006.83-1.83 5 5 0 00-1.83-6.83l-62.034-35.816L182 10.862l166.592 96.182-57.396 33.136a5 5 0 105 8.66l57.396-33.136v192.364L182 407.138z"
                              fill="#846F75"
                            />
                            <Path
                              d="M199.07 129.486c-6.346 0-12.332 2.218-17.07 6.218-4.738-4-10.722-6.218-17.07-6.218-14.654 0-26.578 11.922-26.578 26.576 0 22.22 36.492 50.146 40.652 53.256a4.994 4.994 0 005.988 0c4.162-3.112 40.652-31.038 40.652-53.256.002-14.654-11.92-26.576-26.574-26.576zM182 198.992c-11.59-9.24-33.646-29.578-33.646-42.928 0-9.14 7.436-16.576 16.578-16.576 5.158 0 9.936 2.358 13.112 6.47a4.999 4.999 0 007.916 0c3.176-4.112 7.956-6.47 13.112-6.47 9.14 0 16.578 7.436 16.578 16.576-.004 13.35-22.06 33.686-33.65 42.928z"
                              fill="#846F75"
                            />
                          </Svg>
                        </View>
                        <View style={[styles.settingTextWrapper, {marginTop: 0}]}><Text style={styles.settingText}>Donations and Support</Text></View>
                      </View>
                    </TouchableOpacity>
