...
// const goToViewWishlistScreen = debounce((componentId, code, saveStatus = false, updateUIFunction = null) =>{
//     // alert('ddd')
...
// const goToScreen = debounce((id, screenName,screenProps = {}, screenOptions = {}) =>{
//     // alert('ddd')
//     Navigation.push(id, {
//       component: {
